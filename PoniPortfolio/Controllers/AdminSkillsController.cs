...
namespace PoniPortfolio.Controllers
{
    public class AdminSkillsController : Controller
    {
        ...
        public AdminSkillsController(PoniPortfolioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Percentage")] Skills skills)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Percentage")] Skills skills)
        {
            if (id != skills.Id)
            {
                return NotFound();
